...
class _EditPostWidgetState extends State<EditPostWidget> {
  ...
  void initState() {
    ...
    _model.titleTextController ??=
        TextEditingController(text: widget.selectedPost?.title);
    _model.titleFocusNode ??= FocusNode();

    _model.captionTextController ??=
        TextEditingController(text: widget.selectedPost?.caption);
